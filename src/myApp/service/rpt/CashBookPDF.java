...
public class CashBookPDF {
    ...
    private List<AbstractDataModel> getCashBookModel(String companyId){
        
      ServiceRequest request = new ServiceRequest("rpt.CachBook.selectByCompanyId");
      request.add("companyId", Long.parseLong(companyId));
//      request.add("beginDate", Date.parse(beginDate));
//      request.add("endDate", Date.parse(endDate));
...
//    	String endDate = request.getParameter("endDate"); 
    	...
    	System.out.println("CashBookPDF parm is " + request);
...
//		service.addParam("endDate", endDate.getValue());
		...
		List<AbstractDataModel> list = sqlSession.selectList( "rpt02_CashBook.selectByCompanyId", companyId) ;
		
		CashBookModel cashBookModel = sqlSession.selectOne( "rpt02_CashBook.selectByCompanyId", companyId) ;
